...
if 'test' in sys.argv:
    ...
    class FastTestRunner(DiscoverRunner):
        def setup_databases(self, **kwargs):
            ...
            # 1. Ignorar por completo el historial de archivos de la carpeta 'migrations'
            settings.MIGRATION_MODULES = {
                app.split('.')[-1]: None 
                for app in settings.INSTALLED_APPS
            }
            
            # 2. Forzar a MariaDB a ignorar restricciones de FK durante la carga inicial
    ...
    # Indicarle a Django que use este ejecutor optimizado dinámicamente
